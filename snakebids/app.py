...
class SnakeBidsApp:
    ...
    @classmethod
    def from_filesystem(
        cls, snakemake_dir, parser=None, args=None, skip_parse_args=False
    ):
        ...
        parser : ArgumentParser, optional
            Parser for the app to use. Defaults to the parser generated by
            `create_parser`.
        args : SnakebidsArgs, optional
        ...
        """
        parser = create_parser() if parser is None else parser
